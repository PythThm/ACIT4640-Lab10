...
output "instance_ip_addr" {
  ...
  value = {
    "public_ip" = module.web_server.instance_desc.public_ip
    "dns_name"  = module.web_server.instance_desc.dns_name
  	"instance_id" = module.web_server.instance_desc.instance_id
  }
